...
| S6 | Aufgaben-Store + Assistent-Tools (Memos/Erinnerungen) | done | (dieser Commit) | 342 | AssistantTask (Kit) + AssistantTasksStore (actor, GRDB v9) + create/list/complete/delete_task; optionales Fälligkeitsdatum; Weiche ASSISTANT_TASKS; AppState-Wiring; +8 Tests (inkl. Cold-Start) |

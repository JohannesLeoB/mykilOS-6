...
| S17 | 🔄 | **Security-Härtung**: AirtableSyncService-Forensik (No-Op), Airtable baseID-Validierung, Google-Identität in Sidebar, PAT-Cleanup (SCHATZ-Scope entfernen, Artikel-DB-Schutz). Aktiv. |
